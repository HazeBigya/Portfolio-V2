      ...
      <main className="relative">
        <section className="relative pt-28 md:pt-36">
          <div className="mx-auto max-w-6xl px-6">
            <a href="/#ai-copilot" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-foreground">
              <ArrowLeft className="h-4 w-4" />
              {"Back to portfolio"}
            </a>

            <div className="mt-6 text-sm font-medium text-brand">{"Capability"}</div>
            ...
            <div className="mt-8 grid gap-4 sm:grid-cols-3">
              {MODES.map((m) => {
                const Icon = m.icon;
                return (
                  <div key={m.title} className="rounded-2xl border border-hairline bg-surface p-5">
            ...
            {/* production context */}
            <div className="mt-12 flex flex-wrap items-center justify-between gap-4 rounded-3xl border border-hairline bg-surface p-6">
              ...
              <a
                ...
                className="group inline-flex shrink-0 items-center gap-2 rounded-full bg-brand px-5 py-2.5 text-sm font-medium text-brand-foreground hover:bg-brand/90"
              >
                {"Read the case study"}
